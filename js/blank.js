(() => {
  ...
  let prevScrollHeight = 0; // 현재 스크롤 위치보다 이전에 위치한 섹션들의 스크롤 높이 합
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 3:
        ...
        if (scrollRatio < values.rectStartY / scrollHeight) {
          step = 1;
          ...
          if (scrollRatio > values.blendHeight[2].end) {
            ...
            values.canvas_scale[2].end = values.canvas_scale[2].start + 0.4;
